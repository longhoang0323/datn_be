...
public interface DichVuRepository extends JpaRepository<DichVu, Long> {
    ...
    @Query("select new be.bds.bdsbes.payload.DichVuResponse1(dv.id, dv.ma, dv.tenDichVu, dv.ghiChu, dv.giaDichVu, dv.trangThai, dv.soLuong, dv.image) from DichVu dv  where dv.id = ?1")
